...
def setup_boss_channel(rmt, ch_name, coll_name, exp_name, datatype, res):
    ch_setup = ChannelResource(ch_name, coll_name, exp_name, "image", "", 0, datatype, res)
...
def setup_boss_resources(rmt, coll_name, exp_name, ch_name, voxel_size, voxel_unit, datatype, res, image_size):
    ...
    coord_frame = setup_boss_coord_frame(rmt, coord_frame_name, image_size, voxel_size, voxel_unit)
    experiment = setup_boss_experiment(rmt, exp_name, coll_name, coord_frame_name, image_size, voxel_size)
    channel = setup_boss_channel(rmt, ch_name, coll_name, exp_name, datatype, res)
